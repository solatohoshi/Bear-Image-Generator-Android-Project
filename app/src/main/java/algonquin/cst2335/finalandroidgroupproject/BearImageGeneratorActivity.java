...
import algonquin.cst2335.finalandroidgroupproject.databinding.ActivityBearImageGeneratorBinding;
import algonquin.cst2335.finalandroidgroupproject.databinding.BearImageBinding;
...
public class BearImageGeneratorActivity extends AppCompatActivity {
     ...
     */
    private ActivityBearImageGeneratorBinding variableBinding;
    /**
    ...
    /**
     * based on item selected, different actions were made.
     * @param item The menu item that was selected.
     *
     * @return true
     */
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        //load activity based on Item ID
        if (item.getItemId() == R.id.item_bear) {
            Intent project4Page = new Intent( BearImageGeneratorActivity.this, BearImageGeneratorActivity.class);
            startActivity(project4Page);
        }
        else if(item.getItemId()== R.id.item_trivia){
            Intent project3Page = new Intent( BearImageGeneratorActivity.this, TriviaQuestionDatabaseActivity.class);
            startActivity(project3Page);
        }else if(item.getItemId() == R.id.item_flight){
            Intent project1Page = new Intent( BearImageGeneratorActivity.this, FlightTrackerActivity.class);
            startActivity(project1Page);
        }else if(item.getItemId() == R.id.item_currency){
            Intent project2Page = new Intent( BearImageGeneratorActivity.this, CurrencyConvertorActivity.class);
            startActivity(project2Page);
        }
        else if (item.getItemId() == R.id.item_help) {
            androidx.appcompat.app.AlertDialog.Builder builder = new androidx.appcompat.app.AlertDialog.Builder( BearImageGeneratorActivity.this );
            builder.setTitle(getString(R.string.instruction))
                    .setMessage(getString(R.string.bearhelp))
                    .show();
        }
        return true;
    ...
    /**
     * This loads the bear image generator activity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        variableBinding = ActivityBearImageGeneratorBinding.inflate(getLayoutInflater());
    ...
    public void deleteImage(int p){
        ...
        builder.setMessage(getString(R.string.deleteMsgBear))
                ...
                .setNegativeButton(getString(R.string.currency_no), (dialog, cl) -> {
                })
                .setPositiveButton(getString(R.string.currency_yes), (dialog, cl) -> {
